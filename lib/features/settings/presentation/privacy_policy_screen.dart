    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text(
            'Rizz собирает технические логи (версия приложения, модель устройства, ошибки, IP-адрес) для отладки и улучшения стабильности. '
            'В настоящее время логи доступны по адресу logs.rizzdp.ru. Мы работаем над тем, чтобы ограничить доступ к ним (пароль или обезличивание). '
            'Пожалуйста, не передавайте в сообщениях конфиденциальные данные, пока эта проблема не будет решена.',
            style: TextStyle(fontSize: 14, height: 1.4),
          ),
        ],
      ),
    ...
    return Column(
      ...
      children: [
        ...
        _buildSection('2. Состав собираемых данных',
          ...
          '• Техническая информация: IP-адрес, ID устройства, модель, версия ОС, Push-токены, системные логи (ошибки, стеки вызовов).\n'
        ...
        _buildSection('4. Правовые основания и хранение данных',
          ...
          '4.4. Логи хранятся на logs.rizzdp.ru и могут быть удалены в любой момент. Мы работаем над ограничением доступа к логам.',
          isLight),
        ...
        _buildSection('5. Передача данных третьим лицам',
          ...
          '5.3. В будущем планируется переход на гибридную модель (собственный сервер + P2P). В этом случае медиафайлы могут передаваться напрямую между пользователями без участия наших серверов. О таких изменениях мы уведомим отдельно.',
          isLight),
        ...
        _buildSection('6. Права пользователя',
          ...
          '• «Право на забвение» — полное удаление аккаунта (функция появится в ближайших обновлениях).\n'
